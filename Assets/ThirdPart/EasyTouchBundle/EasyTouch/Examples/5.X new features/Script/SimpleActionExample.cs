...
public class SimpleActionExample : MonoBehaviour {
	...
	// Change the color
    public void ChangeColor(HedgehogTeam.EasyTouch.Gesture gesture)
    {
		RandomColor();
	}
	
	// display action action
    public void TimePressed(HedgehogTeam.EasyTouch.Gesture gesture)
    {
		textMesh.text = "Down since :" + gesture.actionTime.ToString("f2");
	}
	
	// Display swipe angle
    public void DisplaySwipeAngle(HedgehogTeam.EasyTouch.Gesture gesture)
    {
