...
public class Swipe : MonoBehaviour {
    ...
    private void On_SwipeStart(HedgehogTeam.EasyTouch.Gesture gesture)
    {
		swipeText.text = "You start a swipe";
	}
	
	// During the swipe
    private void On_Swipe(HedgehogTeam.EasyTouch.Gesture gesture)
    {
	...
	// At the swipe end 
    private void On_SwipeEnd(HedgehogTeam.EasyTouch.Gesture gesture)
    {
