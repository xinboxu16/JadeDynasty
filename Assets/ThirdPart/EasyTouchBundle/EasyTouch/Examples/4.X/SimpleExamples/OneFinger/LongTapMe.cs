...
public class LongTapMe : MonoBehaviour {
    ...
    private void On_LongTapStart(HedgehogTeam.EasyTouch.Gesture gesture)
    {
	...
	// During the long tap 
    private void On_LongTap(HedgehogTeam.EasyTouch.Gesture gesture)
    {
	...
	// At the long tap end
    private void On_LongTapEnd(HedgehogTeam.EasyTouch.Gesture gesture)
    {
