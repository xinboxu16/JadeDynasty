...
public class PinchMe : MonoBehaviour {
    ...
    private void On_TouchStart2Fingers(HedgehogTeam.EasyTouch.Gesture gesture)
    {
	...
	// At the pinch in
    private void On_PinchIn(HedgehogTeam.EasyTouch.Gesture gesture)
    {
	...
	// At the pinch out
    private void On_PinchOut(HedgehogTeam.EasyTouch.Gesture gesture)
    {
	...
	// At the pinch end
    private void On_PinchEnd(HedgehogTeam.EasyTouch.Gesture gesture)
    {
