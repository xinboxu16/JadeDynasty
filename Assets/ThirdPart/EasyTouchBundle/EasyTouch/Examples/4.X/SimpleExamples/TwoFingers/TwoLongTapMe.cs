...
public class TwoLongTapMe : MonoBehaviour {
    ...
    void On_LongTapStart2Fingers(HedgehogTeam.EasyTouch.Gesture gesture)
    {
	...
	// During the long tap
    void On_LongTap2Fingers(HedgehogTeam.EasyTouch.Gesture gesture)
    {
		// Verification that the action on the object
		if (gesture.pickedObject == gameObject){		
	...
	// At the long tap end
    void On_LongTapEnd2Fingers(HedgehogTeam.EasyTouch.Gesture gesture)
    {
		// Verification that the action on the object
		if (gesture.pickedObject == gameObject){
    ...
    void On_Cancel2Fingers(HedgehogTeam.EasyTouch.Gesture gesture)
    {
