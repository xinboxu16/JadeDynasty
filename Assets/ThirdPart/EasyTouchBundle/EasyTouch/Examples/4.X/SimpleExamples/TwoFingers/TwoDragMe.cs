...
public class TwoDragMe : MonoBehaviour {
    ...
    void On_DragStart2Fingers(HedgehogTeam.EasyTouch.Gesture gesture)
    {
	...
	// During the drag
    void On_Drag2Fingers(HedgehogTeam.EasyTouch.Gesture gesture)
    {
	...
	// At the drag end
    void On_DragEnd2Fingers(HedgehogTeam.EasyTouch.Gesture gesture)
    {
