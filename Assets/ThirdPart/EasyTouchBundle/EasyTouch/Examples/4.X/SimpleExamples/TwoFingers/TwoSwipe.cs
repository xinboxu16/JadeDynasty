...
public class TwoSwipe : MonoBehaviour {
    ...
    private void On_SwipeStart2Fingers(HedgehogTeam.EasyTouch.Gesture gesture)
    {
	...
	// During the swipe
    private void On_Swipe2Fingers(HedgehogTeam.EasyTouch.Gesture gesture)
    {
	...
	// At the swipe end 
    private void On_SwipeEnd2Fingers(HedgehogTeam.EasyTouch.Gesture gesture)
    {
