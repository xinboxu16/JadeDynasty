...
skill(120132)
{
  ...
  section(566)//第一段
  {
    ...
    areadamage(130, 0, 1.5, 1.5, 3, true)
		{
			stateimpact("kDefault", 12010201);
			stateimpact("kKnockDown", 12990000);
			stateimpact("kLauncher", 12010202);
    ...
    areadamage(230, 0, 1.5, 1.5, 3, true)
		{
			stateimpact("kDefault", 12010201);
			stateimpact("kKnockDown", 12990000);
			stateimpact("kLauncher", 12010202);
    ...
    areadamage(330, 0, 1.5, 1.5, 3, true)
		{
			stateimpact("kDefault", 12010201);
			stateimpact("kKnockDown", 12990000);
			stateimpact("kLauncher", 12010202);
    ...
    areadamage(430, 0, 1.5, 1.5, 3, true)
		{
			stateimpact("kDefault", 12010201);
			stateimpact("kKnockDown", 12990000);
			stateimpact("kLauncher", 12010202);
    ...
    areadamage(530, 0, 1.5, 1.5, 3, true)
		{
